...
data_root='D:/Phdworks/data/vocation'
...
def find_event_SingleGaze():
    ...
    for file_i in range(len(files)):
        ...
        np.save(op.join(data_root, 'event/test', 'SingleGaze.npy'), SingleGaze)
...
def find_event_GazeFollow():
    ...
    for file_i in range(len(files)):
        ...
        np.save(op.join(data_root, 'event/test', 'GazeFollow.npy'), GazeFollow)
...
def find_event_AvertGaze():
    ...
    for file_i in range(len(files)):
        ...
        np.save(op.join(data_root, 'event/test', 'AvertGaze.npy'), AvertGaze)
...
def find_event_MutualGaze():
    ...
    for file_i in range(len(files)):
        ...
        np.save(op.join(data_root, 'event/test', 'MutualGaze.npy'), MutualGaze)
...
def find_event_JointAtt():
    ...
    for file_i in range(len(files)):
        ...
        np.save(op.join(data_root, 'event/test', 'JointAtt.npy'), JointAtt)
